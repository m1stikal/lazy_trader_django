...
def pre_process(stocks,stock):
    stocks[stock]["ticker"]=yf.Ticker(stock) #, verify=False)
    stock_df = stocks[stock]["ticker"].history(period=stocks[stock]["period"], interval=stocks[stock]["interval"], verify=False)
