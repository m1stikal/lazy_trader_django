...
from .views import StockCreateView, StockUpdateView, OpenPositionCreateView, OpenPositionUpdateView,StockListView,OpenPositionListView,StockDeleteView,OpenPositionDeleteView,index,OpenPositionCreateForStockView
